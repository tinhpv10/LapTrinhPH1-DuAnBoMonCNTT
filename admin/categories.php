...
<head>
    ...
    <style>
        ...
        .sidebar { min-height: 100vh; background: #343a40; padding: 0; }
        ...
        .sidebar .brand { background: #212529; padding: 18px 20px; font-size: 20px; font-weight: bold; color: #fff; }
        .main-content { padding: 30px; }
        .card { border: none; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); }
        .table th { background: #f8f9fa; }
        .badge-pill { padding: 6px 12px; font-size: 13px; }
    </style>
</head>
<body>
                            ...
                            <form method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                           placeholder="VD: Áo nam, Váy nữ..."
                                           required value="<?= htmlspecialchars($editCategory['name'] ?? '') ?>">
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-<?= $action === 'edit' ? 'warning' : 'success' ?> btn-block">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">
                                    Danh sách danh mục
                                    <span class="badge badge-primary badge-pill ml-2"><?= count($categories) ?></span>
                                </h5>
                                <!-- Tìm kiếm -->

...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .input-wrap input:focus~.ico-left {
            color: var(--green);
        }
            ...
            <form action="register.php" method="POST" id="reg-form" novalidate>
                ...
                <div class="field <?= isset($errors['name']) ? 'has-error' : '' ?>">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="text" id="name" name="name" placeholder="Nguyễn Văn A"
                            value="<?= htmlspecialchars($old['name'] ?? '') ?>" autocomplete="name"
                            class="<?= isset($errors['name']) ? 'error' : '' ?>">
                        <i class="ti ti-circle-check ico-status" id="name-ok"></i>
                        <i class="ti ti-circle-x   ico-status <?= isset($errors['name']) ? 'err' : '' ?>"
                            id="name-err"></i>
                    </div>
                ...
                <div class="field <?= isset($errors['email']) ? 'has-error' : '' ?>">
                    ...
                    <div class="input-wrap">
                        ...
                        <i class="ti ti-circle-x   ico-status <?= isset($errors['email']) ? 'err' : '' ?>"
                            id="email-err"></i>
                    </div>
                ...
                <div class="field <?= isset($errors['password']) ? 'has-error' : '' ?>">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="password" name="password"
                            placeholder="Tối thiểu 6 ký tự, gồm chữ và số" autocomplete="new-password"
                ...
                <div class="field <?= isset($errors['confirm']) ? 'has-error' : '' ?>">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="confirm" name="confirm" placeholder="Nhập lại mật khẩu"
                            autocomplete="new-password" class="<?= isset($errors['confirm']) ? 'error' : '' ?>">
                ...
                <label class="agree-row">
                    ...
                    <span>Tôi đồng ý với <a href="#" class="link-green">điều khoản sử dụng</a> và <a href="#"
                            class="link-green">chính sách bảo mật</a></span>
                </label>
